...
COPY src/SingleStochasticSearch/master/master.js ./

# Copy slave.js from the slave folder
COPY src/SingleStochasticSearch/slave/slave.js ./

# Copy the shared solver.js from the parent context into /app.
COPY src/SingleStochasticSearch/solver.js ./

COPY src/SingleStochasticSearch/master/saveSolution.js ./
